...
if __name__ == '__main__':
    jpgs_path   = r"F:\datasets\JPEGImages"
    pngs_path   = r"F:\datasets\SegmentationClass"
    ...
    classes = ["_background_","deck"]
    
    count = os.listdir(r"F:\最终语义分割数据集")
    for i in range(0, len(count)):
        path = os.path.join(r"F:\最终语义分割数据集", count[i])
