...
from yolov5BoatDetection.nets.ConvNext import ConvNeXt_Small, ConvNeXt_Tiny
from yolov5BoatDetection.nets.CSPdarknet import C3, Conv, CSPDarknet
from yolov5BoatDetection.nets.Swin_transformer import Swin_transformer_Tiny
